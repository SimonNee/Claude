...
15. **Float `f` suffix in CSV**: The `f` suffix is REPL-only; `save` and `0:` never write it
16. **Shell commands**: Use `system "cmd"` to call external tools; do not spawn wrapper scripts
